...
function getDatas() {
    ...
    if (keyword === undefined)
    {
        ...
        datas.forEach(elm => {
            htmtDatas += `
                 <a href="../trangchitiet/chitiet.html#${elm.idNumber}" onclick="renderCurrentPage(${elm.idNumber})">
                 <div class="noidung1">
                     <div class="hinhanh" onclick="renderCurrentPage(${elm.idNumber})"><img src="../${elm.image}" alt="" height="100%" width="100%"></div>
                     <div class="thongtin">
                         <a class="themchovui" href="../trangchitiet/chitiet.html#${elm.idNumber}" style="text-decoration: none;">${elm.title}</a><br>
                         <a class="themchovui" href="../clickdoctruyen/doctruyen.html#${elm.idNumber}" style="text-decoration: none;" onclick="saveHistory(${elm.idNumber})">Chap 1</a>
                     </div>
